...
public class PersonDAO extends GenericDAO<Person>{
	...
	public Person findByFullName(String fistName, String lastName){
		String jpql = "from Person p where p.fistName like ? and p.lastName like ?";
		return findOne(jpql, fistName, lastName);
	}
